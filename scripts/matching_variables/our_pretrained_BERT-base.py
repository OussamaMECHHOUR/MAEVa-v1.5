...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Code to reproduce our best results for matching variable descriptions using our best pretrained BERT-base model.")

    parser.add_argument("--model_path", default="scripts/Further pretraining/saved models/our_pretrained_BERT-base", help="Path to the weights and tokenizer of our best pretrained BERT-base model")
    ...
    parser.add_argument("--output_results", default="outputs/matching_variables/our_pretrained_BERT-base/BERT_results_evaluation.xlsx", help="Path to save top-k matching results (.xlsx)")
    parser.add_argument("--output_validation", default="outputs/matching_variables/our_pretrained_BERT-base/BERT_validation_evaluation.xlsx", help="Path to save validation results (.xlsx)")
